<?php
/* Smarty version 3.1.30, created on 2017-03-16 16:43:25
  from "F:\wwwroot\lc\application\modules\admin\views\Poolbill.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58ca502d4a4249_16172406',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6c843f9b4be939c429efe9cbf0d59890abcd63aa' => 
    array (
...
function content_58ca502d4a4249_16172406 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html ng-app="myapp">
<head>
...
"
            max-size="5"
            total-items="<?php echo $_smarty_tpl->tpl_vars['poolbillNum']->value;?>
">
        </ul>
    </div>
...
>
    angular.module("myapp",["ui.bootstrap","ngAnimate","utils"]).controller("mainCtrl",function($scope,zhMsg)
    {
        ...
        {   isSelectAll = false;
            getURL(utils.sprintf("/admin/home/getpoolbill?page=%d&Name=%s",$scope.currentPage,$scope.Name.trim())).then(function(data)
            {   $scope.list = data;
